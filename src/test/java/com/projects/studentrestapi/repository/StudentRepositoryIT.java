...
public class StudentRepositoryIT {
    ...
    public void givenStudentList_whenFindAll_thenStudentList() {
        ...
        assertThat(students.size()).isEqualTo(studentRepository.findAll().size());
    }
    ...
    public void givenFirstNameAndLastName_whenFindByJPQL_thenReturnStudentObject() {
        ...
        // when
        Student existingStudent = studentRepository.findByJPQL(savedStudent.getFirstName(), savedStudent.getLastName());
    ...
    public void givenFirstNameAndLastName_whenFindByJPQLNamedParams_thenReturnStudentObject() {
        ...
        // when
        Student existingStudent = studentRepository.findByJPQLNamedParams(savedStudent.getFirstName(), savedStudent.getLastName());
    ...
    public void givenFirstNameAndLastName_whenFindByNativeQuery_thenReturnStudentObject() {
        ...
        // when
        Student existingStudent = studentRepository.findByNativeSQL(savedStudent.getFirstName(), savedStudent.getLastName());

        // then
        assertThat(existingStudent).isNotNull();
        assertThat(existingStudent.getId()).isEqualTo(savedStudent.getId());
    }
    ...
    public void givenFirstNameAndLastName_whenFindByNativeQueryNamed_thenReturnStudentObject() {
        ...
        // when
        Student existingStudent = studentRepository.findByNativeSQLNamed(savedStudent.getFirstName(), savedStudent.getLastName());
        // then
        assertThat(existingStudent).isNotNull();
    }
}
